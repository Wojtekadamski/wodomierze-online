...
def user_overview(user_id):
    ...
    unassigned_users = []
    assigned_meters = []
    selected_months = [str(month.month) for month in user.report_months]
    ...
    if edit_user_form.validate_on_submit():
        ...
        selected_months = request.form.getlist('report_months')
        UserReportMonth.query.filter_by(user_id=user.id).delete()  # Usuń istniejące miesiące
